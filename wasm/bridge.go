...
func BridgeFromBytes(name string, bytes []byte, imports *wasmer.Imports) (*Bridge, func(), error) {
	b := new(Bridge)
	if imports == nil {
	...
	return b, dealloc, nil
}

func BridgeFromFile(name, file string, imports *wasmer.Imports) (*Bridge, func(), error) {
...
func (b *Bridge) resetMemoryDataViewBridge() {
	// is it ok ?
	b.memory = b.instance.Memory.Data()
}
